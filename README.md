...
Four vertically structured sections
A fixed hamburger navigation menu
Interactive slider (carousel) in the first section
Accordion-based content display for services
Grid-based layout for company values
...
Form Fields:
Name (max 100 characters, letters only)
Phone Number (max 10 digits, numbers only)
